...
#Recruitment
Rec <- c(28416, 33088, 44582, 60598, 48689)*1000 #Recruitment at age 0 for the most recent 5 years, 2015-2019; numbers were reported in thousands in the MTA report.
R_mean <- mean(Rec)
...
for (i in sim_ids) {
  ...
  saveRDS(nage_i, file = file.path(Nage.dat, sprintf("summerflounder_Nage_%03d.rds", i)))
  message(sprintf("Saved summerflounder_Nage_%03d.rds", i))
}
