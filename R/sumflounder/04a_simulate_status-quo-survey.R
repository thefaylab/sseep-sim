...
#Compare
survdat_sf_sq_1 <- readRDS(here(survdat, "summerflounder_spring_001_25_sq_survey.rds"))

survdat_sf_sq_1$setdet



#Count
sq_sf <- survdat_sf_sq_1$setdet
