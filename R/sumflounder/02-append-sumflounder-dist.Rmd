...
### LOAD DATA ####
# the survey Grid
grid <- readRDS(here(sdmtmb.dir, "survey_grid_Jun2022.rds")) |>
  rename(strat = STRATUM, # rename to match column calls within SimSurvey functions
         depth = AVGDEPTH) |>
...
spring_preds <- readRDS(file = here("data", "rds", "sumflounder-spring-preds.rds"))
