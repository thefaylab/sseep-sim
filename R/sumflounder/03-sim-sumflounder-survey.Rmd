...
strat_n <- surv_dat$setdet |> filter(year == 1, sim == 1) |> group_by(strat) |> summarise(n_sets = length(set)) |> arrange(desc(n_sets))
...
saveRDS(surv_dat1, here("R", "sumflounder", "data", "sumflounder_survdat_25sims.rds"))
```
