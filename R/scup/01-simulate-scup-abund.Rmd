...
pop_dist1 <- sim_abundance(ages = 0:7, years = 1:4, 
...
round(pop_dist1$N)
plot_surface(pop_dist1, mat = "N")
Nage_1 <- tibble(age = 0:7, pop_dist1$N0)
...
```{r, include = FALSE}
### save the data
saveRDS(pop_dist1, here::here("R", "scup", "data", "scup_abundance.rds"))
saveRDS(Nage_1, here::here("R", "scup", "data", "scup_Nage.rds"))
```
