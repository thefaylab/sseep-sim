...
q = force_sim_logistic(k = -1, x0 = 2.8, plot = TRUE, force_age = TRUE, age = 0, force_sel = 0)
...
## SAVE THE DATA ####
saveRDS(trueN, here(surv.prods, str_c(species, season, "all_rel-TrueN-100pops.rds", sep = "_")))
...
ggplot(trueN, aes(x = year, y = rel_N, group = pop)) +
  ...
  labs(
    ...
    subtitle = "Across 100 populations over 15 years, spring season",
