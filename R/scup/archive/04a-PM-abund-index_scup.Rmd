...
strata_wts <- readRDS(here(sseep.analysis, "data", "rds", "active_strata.rds")) |>
  rename(strat = STRATUM)

obs_stratmu <- readRDS(here("data", "rds", "num-strat-mu_included.rds")) |> filter(SVSPP == 143, EST_YEAR %in% c(2019:2021), SEASON == "SPRING")
