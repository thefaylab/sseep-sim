...
pop84 <- readRDS(here("data", "rds", "dists", "scup_spring_084_abund-dist.rds"))
...
dist_84 <- readRDS(here("data", "rds", "dists", "scup_084_dist-only.rds"))
dist_old <- readRDS(here("data", "rds", "dists", "scup_2_sdm-dist-only.rds"))
ggplot(dist_84) +
