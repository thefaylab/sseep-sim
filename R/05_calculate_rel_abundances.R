...
survdat_precl <- readRDS(here(survdat, str_c(species, season, length(nsims), nsurveys,  "precl-surv-dat.rds", sep = "_")))
...
survdat_reall <- readRDS(here(survdat, str_c(species, season, length(nsims), "sims", "locs", nsurveys, "survdat.rds", sep = "_")))
...
indices20 <- bind_rows(ihat_sq1, ihat_precl1, ihat_reall1)
...
ggplot() +
  ...
  geom_point(data = indices20, aes(y = rel_ihat, color = fct_inorder(scenario)), position = position_dodge(width = 0.5)) + labs(x = "Year", y = "Relative Abundance (in kilograms) ", subtitle = "Relative abundance of fall summer flounder", color = "Scenario") +
  ylim(0, NA)
...
saveRDS(indices20, here(surv.prods, str_c(species, season, "all-ihat_1pop-20survs.rds", sep = "_")))

# saveRDS(indices20_nw, here(surv.prods, str_c(species, season, "all-ihat_1pop-20survs_nowind.rds", sep = "_")))
saveRDS(ihat_sq1, here(surv.prods, str_c(species, season, "1pop-20sq_rel-ihat.rds", sep = "_")))
saveRDS(ihat_precl1, here(surv.prods, str_c(species, season, "1pop-20precl_rel-ihat.rds", sep = "_")))
saveRDS(ihat_reall1, here(surv.prods, str_c(species, season, "1pop-20reall_rel-ihat.rds", sep = "_")))
saveRDS(ihat_sq_nw1, here(surv.prods, str_c(species, season, "1pop-20sq_rel-ihat_nowind.rds", sep = "_")))
saveRDS(ihat_precl_nw1, here(surv.prods, str_c(species, season, "1pop-20precl_rel-ihat_nowind.rds", sep = "_")))
saveRDS(ihat_reall_nw1, here(surv.prods, str_c(species, season, "1pop-20reall_rel-ihat_nowind.rds", sep = "_")))
